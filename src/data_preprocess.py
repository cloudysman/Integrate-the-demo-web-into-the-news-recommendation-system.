...
def parse_news(source, target, category2int_path, word2int_path,
    ...
    if 'N53572' in news['id'].values:
        print("N53572 exists in the original news data")
    else:
        print("N53572 is missing in the original news data")
    def parse_row(row):
        new_row = [
            row.id,
...
if __name__ == '__main__':
    train_dir = r'C:\Users\huyinit\Desktop\HieuDT\news-recommendation\src\data\train'
    val_dir = r'C:\Users\huyinit\Desktop\HieuDT\news-recommendation\src\data\val'
    test_dir = r'C:\Users\huyinit\Desktop\HieuDT\news-recommendation\src\data\test'

    print('Process data for training')

    print('Parse behaviors')
    parse_behaviors(path.join(r'D:\HieuDT\news-recommendation\src\data\train\behaviors.tsv'),
                    path.join(r'D:\HieuDT\news-recommendation\src\data\train\behaviors_parsed.tsv'),
                    path.join(r'D:\HieuDT\news-recommendation\src\data\train\user2int.tsv'))

    print('Parse news')
    parse_news(path.join(r'D:\HieuDT\news-recommendation\src\data\train\news.tsv'),
               path.join(r'D:\HieuDT\news-recommendation\src\data\train\news_parsed.tsv'),
               path.join(r'D:\HieuDT\news-recommendation\src\data\train\category2int.tsv'),
               path.join(r'D:\HieuDT\news-recommendation\src\data\train\word2int.tsv'),
               path.join(r'D:\HieuDT\news-recommendation\src\data\train\entity2int.tsv'),
               mode='train')

    print('Generate word embedding')
    generate_word_embedding(
        r'D:\HieuDT\news-recommendation\src\data\glove\glove.840B.300d-001.txt',
        path.join(r'D:\HieuDT\news-recommendation\src\data\train\pretrained_word_embedding.npy'),
        path.join(r'D:\HieuDT\news-recommendation\src\data\train\word2int.tsv'))

    print('Transform entity embeddings')
    transform_entity_embedding(
        path.join(r'D:\HieuDT\news-recommendation\src\data\train\entity_embedding.vec'),
        path.join(r'D:\HieuDT\news-recommendation\src\data\train\pretrained_entity_embedding.npy'),
        path.join(r'D:\HieuDT\news-recommendation\src\data\train\entity2int.tsv'))
